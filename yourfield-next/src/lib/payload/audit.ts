...
import type { AfterChangeHook as GlobalAfterChangeHook } from 'payload/dist/globals/config/types';
...
const requestUserAgentFrom = (req: PayloadRequest) => headerValue(req.headers?.['user-agent']);
