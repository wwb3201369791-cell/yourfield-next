          ...
          <aside className="h-fit rounded border border-border bg-bg-light p-6">
            ...
            <dl className="mt-6 grid gap-4 text-sm">
              <div>
                ...
                <dd className="mt-1 text-text-light">{t('page.compliance.finalCopyTodo')}</dd>
              </div>
              <div>
                <dt className="font-bold text-primary">{t('page.compliance.icpLabel')}</dt>
                <dd className="mt-1 text-text-light">{t('page.compliance.icpTodo')}</dd>
              </div>
              <div>
                <dt className="font-bold text-primary">{t('page.compliance.policeLabel')}</dt>
                <dd className="mt-1 text-text-light">{t('page.compliance.policeTodo')}</dd>
              </div>
            </dl>
          </aside>
