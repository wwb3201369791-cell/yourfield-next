...
import { localized, type ProductGroupId } from '@/lib/mock/products';
...
type CapabilityKey = 'rd' | 'manufacturing' | 'standards' | 'industries' | 'custom' | 'delivery';
  ...
  return (
    <>
      ...
      <section className="home-hero relative isolate overflow-hidden bg-primary text-white">
        <HeroBackgroundVideo
          loopSrc={resolvePublicVideoUrl('/video/home/hero-campus-background-loop.mp4')}
          fullSrc={resolvePublicVideoUrl('/video/home/hero-campus-background-original.mp4')}
