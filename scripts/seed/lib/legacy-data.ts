...
export const productSeeds: ProductSeed[] = [
  {
    ...
    name: localized(
      '消防员灭火防护服（作战款）',
      'Firefighter Protective Suit (Combat Style)',
      'Пожарный защитный костюм (боевой тип)',
    ),
    description: localized(
    ...
    tags: localized(
      '消防服,灭火防护服,作战款',
      'firefighter suit,firefighting protection,combat style',
      'пожарный костюм,защитная одежда пожарного',
    ),
  },
  {
    ...
    description: localized(
      '用于电力检修和高风险电弧作业的防护服产品。',
      'Protective clothing for power maintenance and arc flash risk scenarios.',
      'Защитная одежда для электромонтажных работ и риска дуговой вспышки.',
    ),
    imagePath: productImage,
    industries: ['power'],
    ...
    tags: localized(
      '防电弧服,电力防护',
      'arc flash suit,power protection',
      'защита от дуги,электрозащита',
    ),
  },
  {
    ...
    name: localized(
      ...
      'Экранирующий костюм для работ под напряжением',
    ),
    description: localized(
      '用于带电作业场景的屏蔽防护服。',
      'Shielding protective clothing for live-line work scenarios.',
      'Экранирующая защитная одежда для работ под напряжением.',
    ),
    imagePath: productImage,
    industries: ['power'],
    standards: ['GB/T 6568'],
    tags: localized(
      '屏蔽服,带电作业',
      'shielding suit,live-line work',
      'экранирующий костюм,работы под напряжением',
    ),
  },
  {
    ...
    description: localized(
      '用于电气作业防护的绝缘手套产品。',
      'Insulating gloves for electrical operation protection.',
      'Изолирующие перчатки для электротехнических работ.',
    ),
    imagePath: productImage,
    industries: ['power'],
    ...
    tags: localized(
      '绝缘手套,电气防护',
      'insulating gloves,electrical protection',
      'изолирующие перчатки,электрозащита',
    ),
  },
  {
    ...
    description: localized(
      '用于化工、应急和污染处置场景的化学防护服。',
      'Chemical protective suit for chemical, emergency, and contamination response scenarios.',
      'Костюм химической защиты для химических, аварийных и загрязненных сред.',
    ),
    imagePath: productImage,
    ...
    tags: localized(
      '防化服,化学防护',
      'chemical suit,chemical protection',
      'химическая защита,защитный костюм',
    ),
  },
  {
    ...
    description: localized(
      '用于医疗和公共卫生场景的防护服产品。',
      'Protective clothing for medical and public health scenarios.',
      'Защитная одежда для медицинских и санитарных задач.',
    ),
    imagePath: productImage,
    industries: ['medical'],
    standards: ['GB 19082'],
    tags: localized(
      '医用防护服,医疗防护',
      'medical protective clothing,medical protection',
  ...
  },
  {
    ...
    description: localized(
      '用于焊接、热作业和金属加工场景的防护服。',
      'Protective clothing for welding, hot work, and metal processing scenarios.',
      'Защитная одежда для сварки, горячих работ и металлообработки.',
    ),
    imagePath: productImage,
    ...
    tags: localized(
      '焊接服,热防护',
      'welding clothing,thermal protection',
      'сварочная одежда,теплозащита',
    ),
  },
];
