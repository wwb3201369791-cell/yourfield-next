...
const images = [
  '/media/firefighter-suit-modeling-jacket-front.png',
  '/media/firefighter-suit-modeling-jacket-back.png',
  '/media/firefighter-suit-modeling-jacket-left.png',
  '/media/firefighter-suit-modeling-jacket-right.png',
  '/media/firefighter-suit-modeling-pants-front.png',
];
