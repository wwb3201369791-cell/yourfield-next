...
const sharedComplianceKeys = [
  ...
  'page.compliance.finalCopyStatus',
  'page.compliance.icpLabel',
  'page.compliance.icpStatus',
  'page.compliance.policeLabel',
  'page.compliance.policeStatus',
...
describe('legal compliance page config', () => {
  ...
  it('keeps required compliance status copy available in every locale', () => {
    const requiredKeys = [
