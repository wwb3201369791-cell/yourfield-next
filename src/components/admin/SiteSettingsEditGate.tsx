...
import type { AdminViewComponent, DocumentViewClientProps, GlobalPermission } from 'payload';
...
type DefaultGlobalViewProps = DocumentViewClientProps & {
  global: {
    admin: {
      components: {
...
const DefaultGlobalView = DefaultEditView as React.ComponentType<DefaultGlobalViewProps>;
